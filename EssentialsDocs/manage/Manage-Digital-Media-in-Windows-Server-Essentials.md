...
-   [Ativar dispositivos de mídia que usam o protocolo SMB para acessar arquivos compartilhados no servidor](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_10)
