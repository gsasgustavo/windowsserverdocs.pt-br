...
- [Recursos da página Início do Painel](#BKMK_Home)

- [Seções administrativas do Painel](#BKMK_Features)

- [Acessar o Painel do Windows Server Essentials.](#BKMK_AccessDb)

- [Utilizar o modo de segurança](#BKMK_UseSafeMode)

##  <a name="basic-features-of-the-dashboard"></a><a name="BKMK_Design"></a> Recursos básicos do painel
...
|3|painel Tarefas|Esse painel exibe links para tarefas e informações que se aplicam a uma categoria selecionada. Clique em uma tarefa ou recurso para exibir informações adicionais.|
...
##  <a name="administrative-sections-of-the-dashboard"></a><a name="BKMK_Features"></a> Seções administrativas do painel
