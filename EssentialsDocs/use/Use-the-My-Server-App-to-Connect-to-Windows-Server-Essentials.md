...
-   **Acesso a bibliotecas e sites de equipe do SharePoint Online** – Aproveite a integração Microsoft 365 com o Windows Server Essentials para acessar sites de equipe do SharePoint Online e abra documentos em suas bibliotecas do SharePoint Online no meu servidor 2012 R2.
...
##  <a name="operating-system-requirements"></a><a name="BKMK_OS"></a> Requisitos do sistema operacional
...
##  <a name="install-my-server"></a><a name="BKMK_Install"></a> Instalar meu servidor
...
2.  Instale o certificado:
    ...
    6.  Selecione **Computador Local** como o local de instalação e clique **Avançar**.
...
##  <a name="use-my-server"></a><a name="BKMK_UseServer"></a> Usar meu servidor
...
###  <a name="features-of-my-server"></a><a name="BKMK_Features"></a> Recursos do meu servidor
