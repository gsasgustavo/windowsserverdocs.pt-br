...
description: Saiba como migrar um domínio existente do Windows Small Business Server 2011 Essentials para o Windows Server 2012 Essentials e, em seguida, migre as configurações e os dados.
ms.date: 10/03/2016
ms.topic: article
