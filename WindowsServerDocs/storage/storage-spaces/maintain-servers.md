---
description: 'Saiba mais sobre: colocando um Espaços de Armazenamento Diretos Server offline para manutenção'
...
Para fazer isso no Gerenciador de cluster de failover, vá para   >  **discos** de armazenamento.
