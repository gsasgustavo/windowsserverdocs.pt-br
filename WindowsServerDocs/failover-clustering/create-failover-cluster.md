...
Para obter exemplos de como adicionar funções clusterizadas, consulte tópicos como [Add-ClusterFileServerRole](/powershell/module/failoverclusters/add-clusterfileserverrole) e [Add-ClusterGenericApplicationRole](/powershell/module/failoverclusters/add-clustergenericapplicationrole).
