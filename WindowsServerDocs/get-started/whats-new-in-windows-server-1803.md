...
description: Saiba sobre os novos recursos de computação, identidade, gerenciamento, automação, rede, segurança e armazenamento no Windows Server, versão 1803.
ms.topic: article
author: greg-lindsay
ms.author: greglin
