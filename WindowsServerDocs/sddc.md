...
![Ícone do Learn, Saiba mais sobre as Soluções do Azure Stack HCI.](media/sddc/learn.png)**[Saiba mais sobre as Soluções do Azure Stack HCI](https://azure.microsoft.com/overview/azure-stack/hci)**

![Ícone do Learn, Saiba mais sobre as Soluções WSSD.](media/sddc/learn.png)**[Saiba mais sobre as Soluções WSSD](https://www.microsoft.com/cloud-platform/software-defined-datacenter)**
...
![Windows Server, imagem do espaçador do diagrama de infraestrutura hiperconvergente.](media/sddc/spacer1.png)![Diagrama de infraestrutura hiperconvergente do Windows Server](media/sddc/hyper-converged.png)

![Ícone do Learn, Saiba mais sobre o Windows Server](media/sddc/learn.png)**[Saiba mais sobre o Windows Server, hiperconvergente](./get-started/whats-new-in-windows-server-2016.md#compute)**
...
![Ícone do Learn, Saiba mais sobre o Hipervisor do Hyper-V.](media/sddc/learn.png)**[Saiba mais sobre o Hipervisor do Hyper-V](https://www.microsoft.com/cloud-platform/server-virtualization)**

### <a name="guest-clustering-with-shared-vhdx"></a>Clustering de convidado com VHDX compartilhado

![Linha que separa a seção Clustering de convidado com VHDX compartilhado.](media/sddc/virtualize-line.png)
...
![Imagem do espaçador do diagrama do clustering de convidado e do VHDX compartilhado.](media/sddc/spacer1.png)![Diagrama do clustering de convidado e do VHDX compartilhado](media/sddc/cluster.png)
...
![Ícone do Learn, Saiba mais sobre o Clustering de convidado com o VHDX compartilhado.](media/sddc/learn.png)**[Saiba mais sobre o Clustering de convidado com o VHDX compartilhado](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn281956(v=ws.11))**

### <a name="hyper-v-replica"></a>Réplica do Hyper-V

![Linha que separa a seção Réplica do Hyper-V.](media/sddc/virtualize-line.png)
...
![Imagem do espaçador do diagrama da Réplica do Hyper-V.](media/sddc/spacer1.png)![Agente de Réplica do Hyper-V](media/sddc/replica.png)
...
![Ícone do Learn, Saiba mais sobre a Réplica do Hyper-V.](media/sddc/learn.png)**[Saiba mais sobre a Réplica do Hyper-V](./virtualization/hyper-v/manage/set-up-hyper-v-replica.md)**

![Faixa Conectar tudo](media/sddc/networking.png)

### <a name="network-controller"></a>Controlador de rede

![Linha que separa a seção Controlador de Rede.](media/sddc/networking-line.png)
...
![Imagem do espaçador do diagrama do Controlador de Rede.](media/sddc/spacer1.png)![Diagrama do Controlador de Rede](media/sddc/netcontroller.png)
...
![Ícone do Learn, Saiba mais sobre o Controlador de Rede.](media/sddc/learn.png)**[Saiba mais sobre o Controlador de Rede](./networking/sdn/technologies/network-controller/network-controller.md)**

### <a name="datacenter-firewall"></a>Firewall do Datacenter

![Linha que separa a seção Firewall do Datacenter.](media/sddc/networking-line.png)
...
![Imagem do espaçador do diagrama do Firewall do Datacenter.](media/sddc/spacer1.png)![Diagrama do Firewall do Datacenter](media/sddc/firewall.png)
...
![Ícone do Learn, Saiba mais sobre o Firewall do Datacenter.](media/sddc/learn.png)**[Saiba mais sobre o Firewall do Datacenter](./networking/sdn/technologies/network-function-virtualization/datacenter-firewall-overview.md)**

### <a name="switch-embedded-teaming"></a>Agrupamento Incorporado de Comutador

![Linha que separa a seção Agrupamento Inserido do Comutador.](media/sddc/networking-line.png)
...
![Imagem do espaçador do diagrama do Agrupamento Inserido do Comutador.](media/sddc/spacer1.png)![Diagrama de agrupamento inserido do comutador](media/sddc/teaming.png)

![Ícone do Learn, Saiba mais sobre o Agrupamento Inserido do Comutador.](media/sddc/learn.png)**[Saiba mais sobre o Agrupamento Inserido do Comutador](./networking/sdn/technologies/set-for-sdn.md)**
...
![Imagem do espaçador do diagrama do Balanceamento de Carga de Software.](media/sddc/spacer1.png)![Diagrama de balanceamento de carga do software](media/sddc/balancer.png)

![Ícone do Learn, Saiba mais sobre o Balanceamento de Carga do Software.](media/sddc/learn.png)**[Saiba mais sobre o Balanceamento de Carga do Software](./networking/sdn/technologies/network-function-virtualization/software-load-balancing-for-sdn.md)**
...
![Imagem do espaçador do diagrama do Espaços de Armazenamento Diretos.](media/sddc/spacer1.png)![Diagrama de Espaços de Armazenamento Diretos](media/sddc/ssd.png)
...
![Ícone do Learn, Saiba mais sobre os Espaços de Armazenamento Diretos.](media/sddc/learn.png)**[Saiba mais sobre os Espaços de Armazenamento Diretos](storage/storage-spaces/storage-spaces-direct-overview.md)**
...
![Imagem do espaçador do diagrama da Qualidade de Serviço do Armazenamento.](media/sddc/spacer1.png)![Diagrama da qualidade de serviço do armazenamento](media/sddc/qos.png)
...
![Ícone do Learn, Saiba mais sobre a QoS do Armazenamento.](media/sddc/learn.png)**[Saiba mais sobre a QoS do Armazenamento](./storage/storage-qos/storage-qos-overview.md)**
...
![Imagem do espaçador do diagrama da réplica de armazenamento.](media/sddc/spacer1.png)
![diagrama da réplica de armazenamento](media/sddc/storage-replica.png)
...
4. Confirmação do site remoto
5. Gravação de aplicativo confirmada

t e t1: dados liberados para o volume, logs sempre realizam gravação

![Ícone do Learn, Saiba mais sobre a Réplica de Armazenamento.](media/sddc/learn.png)**[Saiba mais sobre a Réplica de Armazenamento](./storage/storage-replica/storage-replica-overview.md)**
...
![Ícone do Learn, Saiba mais sobre a malha protegida.](media/sddc/learn.png)**[Saiba mais sobre a malha protegida](./security/guarded-fabric-shielded-vm/guarded-fabric-and-shielded-vms.md)**

### <a name="shielded-vms"></a>VMs blindadas

![Linha que separa a seção VMs Blindadas.](media/sddc/security-line.png)
...
![Imagem do espaçador de diagrama blindado.](media/sddc/spacer1.png)![diagrama blindado](media/sddc/shielded.png)
...
![Ícone do Learn, Saiba mais sobre VMs blindadas.](media/sddc/learn.png)**[Saiba mais sobre VMs blindadas](./security/guarded-fabric-shielded-vm/guarded-fabric-and-shielded-vms.md)**

### <a name="host-guardian-service"></a>Serviço Guardião de Host

![Linha que separa a seção Serviço Guardião de Host.](media/sddc/security-line.png)

O Serviço Guardião de Host detém as chaves para malhas legítimas, bem como máquinas virtuais criptografadas.

![Imagem do espaçador de diagrama do guardião.](media/sddc/spacer1.png)![diagrama do guardião](media/sddc/guardian.png)

![Ícone do Learn, Saiba mais sobre o Serviço Guardião de Host.](media/sddc/learn.png)**[Saiba mais sobre o Serviço Guardião de Host](./security/guarded-fabric-shielded-vm/guarded-fabric-manage-hgs.md)**

### <a name="device-health-attestation"></a>Atestado de Integridade do Dispositivo

![Linha que separa a seção Atestado de Integridade do Dispositivo.](media/sddc/security-line.png)
...
![Imagem do espaçador do diagrama do atestado.](media/sddc/spacer1.png)![diagrama do atestado](media/sddc/attestation.png)
...
![Ícone do Learn, Saiba mais sobre o Atestado de Integridade do Dispositivo.](media/sddc/learn.png)**[Saiba mais sobre o Atestado de Integridade do Dispositivo](./security/device-health-attestation.md)**
...
![Linha que separa a seção Desired State Configuration do PowerShell.](media/sddc/management-line.png)
...
![Imagem do espaçador do diagrama do Desired State Configuration.](media/sddc/spacer1.png)![Diagrama da Desired State Configuration](media/sddc/dsc.png)
...
![Ícone do Learn, Saiba mais sobre o DSC do PowerShell.](media/sddc/learn.png)**[Saiba mais sobre o DSC do PowerShell](/powershell/dsc/overview)**
...
![Imagem do espaçador do diagrama do Virtual Machine Manager.](media/sddc/spacer1.png)![Diagrama do Virtual Machine Manager](media/sddc/vmm.png)
...
![Ícone do Learn, Saiba mais sobre o System Center VMM.](media/sddc/learn.png)**[Saiba mais sobre o System Center VMM](/system-center/vmm/)**

### <a name="windows-admin-center"></a>Windows Admin Center

![Linha que separa a seção Windows Admin Center.](media/sddc/management-line.png)
