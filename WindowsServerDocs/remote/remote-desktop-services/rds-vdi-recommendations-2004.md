...
|Microsoft Edge|Permitir conteúdo da Web na página Nova Guia| N/D |**Desabilitado** (Com essa configuração desabilitada, o Microsoft Edge abre uma nova guia com uma página em branco. Se essa configuração estiver configurada, os usuários não poderão alterar a configuração.)|
