...
description: Saiba como aproveitar os recursos de gerenciamento de tráfego das políticas de DNS para implantações de divisão-Brain com Active Directory zonas de DNS integradas no Windows Server 2016.
manager: brianlic
ms.topic: article
