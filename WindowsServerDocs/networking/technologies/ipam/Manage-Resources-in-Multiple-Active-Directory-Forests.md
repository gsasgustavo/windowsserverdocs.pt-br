...
description: Saiba como usar o IPAM para gerenciar controladores de domínio, servidores DHCP e servidores DNS em várias florestas de Active Directory.
manager: brianlic
ms.topic: article
