...
![Ícone de marca de seleção, configure AD FS para enviar declarações para um agente Web com reconhecimento de declaração AD FS 1. x. ](media/2b05dce3-938f-4168-9b8f-1f4398cbdb9b.gif)**Lista de verificação: configurar AD FS para enviar declarações para um \- Agente Web com reconhecimento de declarações AD FS 1. x**

|Tarefa|Referência|
|--------|-------------|
|Planeje a interoperabilidade entre AD FS no Windows Server 2012 e versões anteriores do AD FS e saiba mais sobre o tipo de declaração ID de nome.|![, Planeje a interoperabilidade entre AD FS no Windows Server 2012. ](media/faa393df-4856-4431-9eda-4f4e5be72a90.gif)[Planejando a interoperabilidade com o AD FS 1. x](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/ff678040(v=ws.11))|
