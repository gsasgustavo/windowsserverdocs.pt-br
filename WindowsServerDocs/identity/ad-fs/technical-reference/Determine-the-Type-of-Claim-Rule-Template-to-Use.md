...
A tabela a seguir descreve todos os tipos de modelos de regra de declaração que você pode usar para criar regras usando o snap-in de gerenciamento de AD FS \- e os benefícios de usar um tipo de modelo sobre outro.
