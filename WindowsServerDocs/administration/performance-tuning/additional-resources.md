...
-   [Configuração e implantação da política de energia no Windows](/windows-hardware/customize/power-settings/configure-processor-power-management-options)

-   [Usando o PowerCfg para avaliar a eficiência de energia do sistema](/previous-versions/windows/it-pro/windows-vista/cc748940(v=ws.10))
...
-   [Diretrizes de ajuste de desempenho para os serviços da Microsoft para o sistema de arquivos de rede](/previous-versions/tn-archive/bb463205(v=technet.10))
...
-   [Desempenho de Active Directory](/previous-versions/dn567654(v=vs.85))
...
-   [O que há de novo no Hyper-V no Windows Server 2016](../../virtualization/hyper-v/what-s-new-in-hyper-v-on-windows.md)

-   [Guia de Configuração de Memória Dinâmica do Hyper-V](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/ff817651(v=ws.10))

-   [Balanceamento de nó NUMA](/archive/blogs/winserverperformance/numa-node-balancing)

-   [Provedor WMI do Hyper-V](/previous-versions/windows/desktop/virtual/windows-virtualization-portal)

-   [Classes WMI do Hyper-V](/previous-versions/windows/desktop/virtual/virtualization-wmi-classes)

-   [Sobre máquinas virtuais e sistemas operacionais convidados](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc794868(v=ws.10))

-   [Otimizando e Solucionando problemas de armazenamento do Hyper-V](/archive/blogs/microsoft_press/new-book-optimizing-and-troubleshooting-hyper-v-storage)
...
-   [Ajuste de desempenho para NTttcp](/previous-versions/dn567663(v=vs.85))

-   [Ttcp](http://en.wikipedia.org/wiki/Ttcp)

-   [Como usar o NTttcp para testar o desempenho da rede](https://msdn.microsoft.com/windows/hardware/gg463264.aspx)

-   [Usando a ferramenta capactiy do servidor de arquivos](/previous-versions/dn567658(v=vs.85))

-   [Usando o servidor de arquivos SPECsfs2008](/previous-versions/dn567653(v=vs.85))

-   [Ajuste de desempenho para a carga de trabalho de vendas e distribuição](/previous-versions/dn567646(v=vs.85))

-   [Ajuste de desempenho para OLTP (processamento de transações online)](/previous-versions/dn567642(v=vs.85))
