...
| symlinkevaluation `<symboliclinktype>` | Controla o tipo de links simbólicos que podem ser criados em um computador. As opções válidas são:<ul><li>**1** -local para links simbólicos locais, `L2L:{0|1}`</li><li>**2** -locais para links simbólicos remotos, `L2R:{1|0}`</li><li>**3** -links simbólicos remotos para locais, `R2L:{1|0}`</li><li>**4** -links simbólicos remotos para remotos, `R2R:{1|0}`</li></ul> |
