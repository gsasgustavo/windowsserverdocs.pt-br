# [Comandos do Windows](windows-commands.md)
## [Chave da sintaxe de linha de comando](command-line-syntax-key.md)
## [Comandos por função de servidor](commands-by-server-role.md)
...
#### [logman import e logman export](logman-import-export.md)
...
### [Referência aos comandos dos Serviços para NFS (Network File System)](services-for-network-file-system-command-reference.md)
