...
description: Saiba como configurar a proteção adicional para o processo de autoridade de segurança local (LSA) para evitar a injeção de código que possa comprometer as credenciais.
ms.topic: article
